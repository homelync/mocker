...
- pre-rebase
- prepare-commit-msg
- GitHub Changelog Generator (homelync/playground)
...
4. `answer()` - 18 edges
5. `GenerateOptions` - 18 edges
6. `serveFromRegistry()` - 18 edges
7. `findMatch()` - 17 edges
...
## Communities (166 total, 83 thin omitted)

### Community 0 - "Schema-Driven Data Generation"

Cohesion: 0.06
Nodes (56): test, answer(), bend(), fulfillError(), fulfillWith(), handleRoute(), HandlerState, inScope() (+48 more)

### Community 1 - "Next.js Adapter and Mock Flag"

Cohesion: 0.06
Nodes (61): CliArgs, integer(), parseCliArgs(), ParsedArgs, options(), UsageError, main(), run() (+53 more)
...
Cohesion: 0.05
Nodes (53): nextConfig, GET(), handler(), POST(), GET(), GET, User, userSchema (+45 more)

### Community 4 - "Registry Key Matching"

Cohesion: 0.10
Nodes (36): deviceListSchema, DeviceList, deviceListSchema, Timeline, timelineSchema, FixedOutcome, fixtureError(), replay() (+28 more)
...
Cohesion: 0.05
Nodes (45): author, bugs, default, dependencies, @homelync/mocker, description, devDependencies, msw (+37 more)
...
Cohesion: 0.05
Nodes (44): author, bugs, default, dependencies, @homelync/mocker, description, devDependencies, playwright-core (+36 more)

### Community 12 - "Mock Package Manifest"

Cohesion: 0.05
Nodes (43): author, bugs, default, types, default, dependencies, @homelync/mocker, description (+35 more)
...
Cohesion: 0.05
Nodes (38): author, bin, mocker, bugs, default, dependencies, @faker-js/faker, @homelync/mocker (+30 more)

### Community 18 - "Oxfmt Formatting Config"

Cohesion: 0.12
Nodes (22): fixtureError(), generate(), replay(), serveFixed(), sleep(), FixtureLookup, fixtureUrl(), readFixture() (+14 more)
...
Cohesion: 0.07
Nodes (27): dependencies, @homelync/mocker, @homelync/mocker-storybook, react, react-dom, zod, devDependencies, msw (+19 more)

### Community 24 - "Community 24"

Cohesion: 0.09
Nodes (22): dependencies, @homelync/mocker, @homelync/mocker-next, next, react, react-dom, zod, devDependencies (+14 more)
...
Cohesion: 0.15
Nodes (19): MockControls, coerce(), CollectionShape, echoInputs(), EMPTY_SHAPE, envelope(), MockRequestInput, paged() (+11 more)

### Community 27 - "Community 27"

Cohesion: 0.15
Nodes (13): InvalidControlError, readControls(), readInt(), BODILESS_STATUSES, handle(), HandleContext, messageOf(), MockEndpoint (+5 more)

### Community 28 - "Community 28"

Cohesion: 0.20
Nodes (19): absentValue(), DEFAULT_NESTED_ARRAY_LENGTH, isAbsent(), LeafNode, leafValue(), pickOne(), valueFor(), walk() (+11 more)

### Community 29 - "Community 29"

Cohesion: 0.10
Nodes (19): dependencies, @homelync/mocker, @homelync/mocker-cli, @homelync/mocker-playwright, zod, devDependencies, @playwright/test, tsx (+11 more)
...
Cohesion: 0.30
Nodes (13): path(), assertOverridePathsExist(), generate(), childPath(), collectLeafKinds(), collectPaths(), elementPath(), findArrayPaths() (+5 more)

### Community 35 - "Community 35"

Cohesion: 0.25
Nodes (10): serveFixed(), decode(), fixturePath(), RELATIVE, safeSegment(), serializeFixture(), signature(), none (+2 more)
...
Cohesion: 0.15
Nodes (13): 1. Responses come from files (`fixed: true`), 2. An undeclared request fails the test (`unmatched: 'error'`), Alongside `@homelync/mocker-next`, Further reading, If your app can start MSW itself, @homelync/mocker-playwright, Options, Quickstart (+5 more)

### Community 38 - "Community 38"

Cohesion: 0.19
Nodes (10): AnySchema, Bounds, BOUNDS_WRITERS, classify(), MutableBounds, NODE_BUILDERS, RawCheck, RawDef (+2 more)

### Community 39 - "Community 39"

Cohesion: 0.17
Nodes (11): As a library, Existing files are kept, Licence, @homelync/mocker-cli, mocker.config.json, `params`: the binding values your app actually sends, Quickstart, Reading a TypeScript registry (+3 more)
...
Cohesion: 0.22
Nodes (8): Entry points, Further reading, @homelync/mocker-next, Or: one route at a time, Quickstart, Registry keys, Testing with Vitest, What `withMocker` does
...
Cohesion: 0.22
Nodes (9): Components that take props, Fixed responses, from a file on disk, Further reading, @homelync/mocker-storybook, One story, one endpoint, different behaviour, Outside Storybook, Quickstart, Under Playwright (+1 more)
...
Cohesion: 0.22
Nodes (8): Controls, per request, Entry points, Further reading, @homelync/mocker, Quickstart, The `MOCK_API` flag, The rule the layout exists for, With Next.js
...
- **595 isolated node(s):** `$schema`, `baseBranch`, `access`, `format`, `changelog` (+590 more)
...
- **Why does `MockRegistry` connect `Schema-Driven Data Generation` to `Next.js Adapter and Mock Flag`, `Damp CLI Commands and Rendering`, `Registry Key Matching`, `Community 36`, `Oxfmt Formatting Config`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `vite` connect `Vitest Type Shims` to `Oxfmt Formatting Config`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
