...
## Corpus Check
- 204 files · ~95,600 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1290 nodes · 1930 edges · 153 communities (84 shown, 69 thin omitted)
...
Cohesion: 0.10
Nodes (38): serializeFixture(), fixtureError(), replay(), serveFixed(), sleep(), fixtureError(), replay(), serveFixed() (+30 more)
...
Cohesion: 0.07
Nodes (55): MockRegistry, answer(), bend(), fulfillError(), fulfillWith(), handleRoute(), HandlerState, inScope() (+47 more)
...
Cohesion: 0.07
Nodes (49): InvalidControlError, readControls(), readInt(), CliOptions, integer(), parseCliArgs(), ParsedArgs, options() (+41 more)
...
## Knowledge Gaps
- **605 isolated node(s):** `$schema`, `baseBranch`, `access`, `format`, `changelog` (+600 more)
...
- **Why does `MockRegistry` connect `Mock Package Manifest` to `Schema-Driven Data Generation`, `Community 24`, `Community 136`, `TypeScript Compiler Options`?**
