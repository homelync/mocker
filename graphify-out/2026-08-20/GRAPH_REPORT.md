...
## Corpus Check
- 201 files · ~94,380 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1264 nodes · 1839 edges · 153 communities (83 shown, 70 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 20 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dff1c434`
...
6. `scripts` - 16 edges
7. `emitOne()` - 14 edges
8. `isRegistryMiss()` - 14 edges
9. `readControls()` - 13 edges
10. `fixturePath()` - 13 edges
...
Cohesion: 0.05
Nodes (69): InvalidControlError, readControls(), readInt(), fixturePath(), serializeFixture(), none, path(), post() (+61 more)
...
Cohesion: 0.14
Nodes (23): clampNumber(), clampString(), context(), DEFAULT_NESTED_ARRAY_LENGTH, FORMAT_GENERATORS, generateNumber(), generateString(), matchRule() (+15 more)

### Community 12 - "Mock Package Manifest"
Cohesion: 0.07
Nodes (52): answer(), bend(), fulfillError(), fulfillWith(), handleRoute(), HandlerState, inScope(), InterceptedRequest (+44 more)
...
Cohesion: 0.16
Nodes (19): MockControls, decode(), RELATIVE, safeSegment(), signature(), hashSeed(), coerce(), CollectionShape (+11 more)

### Community 18 - "Oxfmt Formatting Config"
Cohesion: 0.15
Nodes (17): ArrayPath, CheckedCounts, CheckedOverrides, Descend, Join, MaxDepth, Opaque, Positions (+9 more)
...
Cohesion: 0.17
Nodes (12): assertOverridePathsExist(), generate(), BODILESS_STATUSES, handle(), HandleContext, messageOf(), MockEndpoint, mockResponse() (+4 more)
...
Cohesion: 0.12
Nodes (25): CliOptions, integer(), parseCliArgs(), ParsedArgs, options(), UsageError, main(), run() (+17 more)

### Community 137 - "Community 137"
Cohesion: 0.17
Nodes (11): PathCounts, PathOverrides, DEFAULT_RULES, SEEDS, CONTEXT, envelope, GenContext, GenerateOptions (+3 more)
...
## Knowledge Gaps
- **599 isolated node(s):** `$schema`, `baseBranch`, `access`, `format`, `changelog` (+594 more)
...
- **Why does `GenerateOptions` connect `Community 137` to `Schema-Driven Data Generation`, `Next Adapter Manifest`, `Mock Package Manifest`, `Directory Fuzzy Search`, `Oxfmt Formatting Config`, `Vitest Type Shims`, `Community 24`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `MockRegistry` connect `Schema-Driven Data Generation` to `Community 24`, `TypeScript Compiler Options`, `Mock Package Manifest`, `Community 136`?**
